          ...
          <div className="flex">
              <div className="left  pl-8 pr-6">
                  <div className="inline-block mb-2">
                      <iframe width="940" height="530" src="https://www.youtube.com/embed/mVMt46CPwHo" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                  </div>
