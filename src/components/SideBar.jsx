                ...
                <div className="side-bar__wrapper w-52">
                    <div className="side-bar__wrapper-categories">
                        <ul className="side-bar__list-top mb-10 space-y-3">
                            ...
                            <LinkTo avatar={trendingBtn} title={"Trending"} width={20} height={20}/>

                            <LinkTo avatar={subscriptionsBtn} title={"Subscriptions"} width={20} height={20}/>
                        </ul>

                        <ul className="side-bar__list-bottom mb-10 space-y-3">
                            <LinkTo avatar={library} title={"Library"} width={20} height={20}/>

                            <LinkTo avatar={history} title={"History"} width={20} height={20}/>

                            <LinkTo avatar={later} title={"Watch later"} width={20} height={20}/>

                            <LinkTo avatar={favourites} title={"Favourites"} width={20} height={20}/>

                            <LinkTo avatar={liked} title={"Liked videos"} width={20} height={20}/>

                            <LinkTo avatar={music} title={"Music"} width={20} height={20}/>

                            <LinkTo avatar={games} title={"Games"} width={20} height={20}/>

                            <LinkTo avatar={more} title={"Show more"} width={20} height={20}/>
                        </ul>
                    </div>
