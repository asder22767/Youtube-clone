                        ...
                        <ul className="header__btn-list flex items-center">
                            <li className="header__btn-items mr-10">
                                <button className="header__btns ">
                                    <img src={camera} alt="" className="header__btn-img" width="27" height="20"/>
                                </button>
                            </li>

                            <li className="header__btn-items mr-10">
                                <button className="header__btns">
                                    <img src={dots} alt="" className="header__btn-img" width="21" height="21"/>
                                </button>
                            </li>

                            <li className="header__btn-items mr-10">
                                <button className="header__btns">
                                    <img src={notifications} alt="" className="header__btn-img" width="22" height="26"/>
                                </button>
                            </li>

                            <li className="header__btn-items">
                                <button className="header__btns">
                                    <img src={userPic} alt="" className="header__btn-img" width="40" height="40"/>
                                </button>
                            </li>
                        </ul>
                    </div>
